    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-[#0a0a0a]/60 border-b border-black/5 dark:border-white/10">
      <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <a href="#how" className="hover:opacity-80">{t('nav.how')}</a>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 text-sm text-black/70 dark:text-white/70 hover:text-black dark:hover:text-white transition"
          ...
          <a href="#demo" className="inline-flex items-center rounded-full bg-brand px-4 py-2 text-white text-sm font-medium shadow-sm hover:brightness-110 transition">{t('nav.demo')}</a>
        </div>
      </div>
    </header>
  );
