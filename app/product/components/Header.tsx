    ...
    <header className="bg-white/60 dark:bg-white/5 backdrop-blur border-b border-black/10 dark:border-white/10 shadow-lg">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="group w-8 h-8 bg-brand/20 rounded-full flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-brand/30 hover:scale-105 hover:shadow-lg cursor-pointer">
            <svg className="w-5 h-5 text-brand transition-all duration-300 ease-in-out group-hover:scale-105" fill="none" stroke="currentColor" viewBox="0 0 24 24">
