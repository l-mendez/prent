      ...
      <section id="solutions" className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
          {[
            ...
            const content = (
              <div className="group rounded-2xl border border-black/10 dark:border-white/10 p-4 sm:p-6 bg-white/60 dark:bg-white/5 backdrop-blur transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-brand/5 hover:-translate-y-0.5 hover:border-brand/15 dark:hover:border-brand/20 hover:bg-white/70 dark:hover:bg-white/8 active:scale-98 active:translate-y-0">
                ...
                <h3 className="font-semibold text-base sm:text-lg transition-all duration-300 ease-in-out group-hover:text-brand/80">{item.title}</h3>
